...
export const VisionMissionCard: React.FC<VisionMissionCardProps> = ({
  ...
  return (
    <div
      ...
      className={`group bg-white rounded-2xl border border-gray-200/90 p-8 sm:p-9 shadow-sm
        hover:shadow-[0_20px_50px_rgba(98,13,156,0.18)] hover:border-[#620d9c]/40
        hover:-translate-y-2 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col ${
          isRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}
    >
      {/* Icon Badge */}
      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#620d9c] via-[#7c1cc0] to-[#9333EA]
      ...
      {/* Title */}
      <h3 className="text-xl font-bold text-brand-dark leading-snug transition-colors group-hover:text-[#620d9c]">
        {item.title}
      </h3>

      {/* Accent Bar */}
      <div className="w-10 h-1 bg-[#620d9c] rounded-full my-3.5 transition-all duration-300 group-hover:w-16" />
